...
/****** Object:  StoredProcedure [service_area].[p_dv_queue_process_test]    Script Date: 30.10.2023 13:55:10 ******/
SET ANSI_NULLS ON
GO
...
--drop procedure [service_area].[p_dv_queue_process]
CREATE procedure [service_area].[p_dv_queue_process](
...
begin catch 
		...
		update [service_area].[queue_execution_log]
		set
